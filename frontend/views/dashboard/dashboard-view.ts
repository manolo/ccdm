...
import * as viewService from '../../generated/DashboardService';

// import types used in services
import ChartSeries from '../../generated/com/vaadin/ccdm/spring/views/dashboard/ChartSeries';
...
export class DashboardView extends LitElement {
  ...
  @property() conversionRate = 18;
  @property() currentUsers = 745;
  ...
  firstUpdated(changedProperties: any) {
    ...
    // Retrieve data from server-side services.
    viewService.healthGridItems()
      .then(items => this.grid.items = items);
    viewService.monthlyVisitorsSeries()
      .then(series => this.addSeries(this.monthlyVisitors, series));
    viewService.responseTimesSeries()
      .then(series => this.addSeries(this.responseTimes, series));
  }
